...
<p>
    ...
    <img src="views/classic/images/nav/line48.png"/>
    <a href="index.php?page=zob/manage/scanMeeting/{MeetingID}" title="Sken složky" onclick="return ConfirmAction('Import přepíše zápis jednání. Sktečně chtete tutu nevratnou akci provést a přepsat data?');"><img src="views/classic/images/nav/scanfolder48.png" /></a>        
    <img src="views/classic/images/nav/line48.png"/>
