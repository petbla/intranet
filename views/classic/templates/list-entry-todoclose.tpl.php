...
<div id="DocumentItems">
  <table>
    ...
    <tr>
      ...
      <td class="">
        <a href="" a_id="{ID}" a_type="entry" data-dms-url="{Url}" data-dms-name="{Name}" data-dms-server="{cfg_webserver}" data-dms-entrytype="{Type}" onclick="wsLogDocumentView('{ID}');" class="">
            {Title}
        </a>
        {editcard}
      </td>
