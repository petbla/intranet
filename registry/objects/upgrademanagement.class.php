...
class upgrademanagement {
    ...
    private function upgrade_249($upVer)
    {
        ...
        // upgrade table 'meetinglinepage'
        $sql = "ALTER TABLE ".$pref."meetinglinepage".
            " ADD `ContentID` int(11) DEFAULT 0";
    ...
    private function upgrade_244($upVer)
    {
        ...
        $sql = "ALTER TABLE ".$pref."resultsearch".
            " ADD `Name` varchar(250) COLLATE utf8_czech_ci DEFAULT ''";
        $this->registry->getObject('db')->executeQuery( $sql );
    ...
    private function upgrade_242($upVer)
    {
        ...
        $sql = "ALTER TABLE ".$pref."meeting".
            " ADD `ParentID` varchar(36) COLLATE utf8_czech_ci DEFAULT '00000000-0000-0000-0000-000000000000'";
        $this->registry->getObject('db')->executeQuery( $sql );
