...
function FPDF($orientation='P', $unit='mm', $format='A4')
{
	...
	$this->PageFormats=array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89),'a5'=>array(420.94,595.28), 
                           'a6'=>array(297.64,420.94),'letter'=>array(612,792), 'legal'=>array(612,1008),
                           'sek'=>array(595.28,289.13), 'a6pr'=>array(252.28,308.98) );
  if(is_string($format))
	...
	//Page margins (1 cm)
	$margin=2.834645669291339/$this->k;
	$this->SetMargins($margin,$margin);
	//Interior cell margin (1 mm)
	$this->cMargin=$margin/10;
	//Line width (0.2 mm)
	$this->LineWidth=0.5669291338582677/$this->k;
